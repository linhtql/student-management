...
import views.HocVienJPanel;
import views.KhoaHocJPanel;
import views.LopHocJPanel;
	...
	class LableEvent implements MouseListener {
		...
		public void mouseExited(MouseEvent e) {
			if (!kindSelected.equalsIgnoreCase(kind)) {
				jpnItem.setBackground(new Color(176, 175, 80));
				jlbItem.setBackground(new Color(176, 175, 80));
			}
