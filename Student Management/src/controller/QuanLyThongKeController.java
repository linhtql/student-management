...
public class QuanLyThongKeController {
	...
	public void setDataToChart2(JPanel jpnItem) {
		...
		JFreeChart ganttChart = ChartFactory.createGanttChart("BIỂU ĐỒ THEO DÕI TÌNH TRẠNG KHÓA HỌC", "Khóa học",
				"Thời gian", ds, true, false, false);
		...
		if (listItem != null) {
			for (KhoaHocBean item : listItem) {
				...
				task = new Task(item.getTen_khoa_hoc(),
